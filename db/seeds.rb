...
org = Api::V1::Repositories::OrganizationRepository.add({ name: 'Eliza Asesores', location: 'Vitoria Gasteiz', phone: '1234567890', email: 'contacto@elizaasesores.com', website: 'https://www.elizaasesores.com', description: 'Eliza Asesores', latitude: 42.84, longitude: -2.67, owner_id: owner.id }, raise_error: true)
