...
const ReviewsComponent = () => {
  return (
    <StyledContainer className="absolute">
      <FeatureItem
        onClick={() => undefined}
        css={{
          position: "relative",
      ...
      <FeatureItem
        ...
        css={{
          ...
          px: "$8",
          mw: "120px",
          animation: `${levitating} 6s ease infinite`,
          backgroundColor: "$cardBackground",
          boxShadow: "$sm",
        }}
      >
...
const Reviews = () => {
  return (
    <div className="relative">
      <div className="absolute inset-x-0 bottom-0 -z-1 transform-gpu blur-3xl sm:top-[-20rem]">
        <svg
          className="relative -z-1 h-[21.1875rem] max-w-none -translate-x-1/2 rotate-[30deg] sm:h-[42.375rem]"
