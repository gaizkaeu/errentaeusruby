...
const CollapsePoints = () => {
  ...
  return (
    <div className="isolate px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 py-24 sm:py-26 lg:py-28">
      <Section css={{ position: "relative" }}>
        <div className="absolute inset-x-0 top-[-20rem] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[-15rem]">
          <svg
            className="relative left-[calc(50%-11rem)] h-[21.1875rem] max-w-none -translate-x-1/2 rotate-[30deg] sm:left-[calc(50%-30rem)] sm:h-[30rem]"
