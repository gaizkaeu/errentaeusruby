      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        <div className=''>
          ...
          <div className="grid grid-cols-1 gap-4">
            {taxIncomes.isLoading || taxIncomes.isError || !taxIncomes.currentData ? <Loading type="points" /> : (
        ...
        <div className="">
          ...
          <div className="grid grid-cols-1 gap-4">
            {appointments.isLoading || appointments.isError || !appointments.currentData ? <Loading type="points" /> : (
