        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div>
            ...
            <Text
              className={
                props.textClass ??
                "text-5xl font-bold text-black sm:text-7xl xl:text-8xl"
              }
              css={{
                textGradient: props.gradient,
              }}
            ...
            {props.subtitle && <Text h4>{t(props.subtitle)}</Text>}
          </div>
        </div>
      </section>
    </header>
