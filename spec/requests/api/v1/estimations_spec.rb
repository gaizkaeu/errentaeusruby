...
RSpec.describe "/api/v1/estimations" do
  ...
  describe "GET /show" do
    ...
    it "renders a successful response" do
      ...
      get api_v1_estimations_path(estimation)
      expect(response).to be_successful
    end
  end
  ...
  describe "POST /estimate" do
    context "with valid parameters" do
      it "generates valid JWT" do
        ...
        expect { JWT.decode(token, Rails.application.config.x.estimation_sign_key, true, { algorithm: 'HS512' }) }.not_to raise_error
      end
  ...
  describe "PATCH /update" do
    ...
    context "with valid parameters" do
      ...
      it "updates the requested api_v1_estimation" do
        estimation = Api::V1::Estimation.create! valid_attributes
        patch api_v1_estimation_url(estimation), params: { estimation: new_attributes }
        estimation.reload
    ...
    context "with invalid parameters" do
      it "renders a response with 422 status (i.e. to display the 'edit' template)" do
        estimation = Api::V1::Estimation.create! valid_attributes
        patch api_v1_estimation_url(estimation), params: { estimation: invalid_attributes }
        expect(response).to have_http_status(:unprocessable_entity)
      end
  ...
  describe "DELETE /destroy" do
    ...
    it "destroys the requested api_v1_estimation" do
      estimation = Api::V1::Estimation.create! valid_attributes
      expect do
        delete api_v1_estimation_url(estimation)
