class RodauthMain < Rodauth::Rails::Auth
  configure do
    ...
    verify_account_email_link do
      "#{Rails.application.config.x.frontend_app}/auth/verify/#{token_param_value(verify_account_key_value)}"
    end

    email_auth_email_link do
      "#{Rails.application.config.x.frontend_app}/auth/email-auth/#{token_param_value(email_auth_key_value)}"
    end
  end
end
